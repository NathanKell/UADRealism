...
namespace UADRealism
{
    ...
    internal class Patch_Ui
    {
        ...
        internal static void Postfix_ConstructorUI(Ui __instance)
        {
            ...
            Debug.LogWarning("Running ConstructorUI(): looking for Fineness");
        ...
        {
            Debug.Log("Attempting to add slider");
        ...
        private static void UpdateFinenessSlider(GameObject fineSlider)
        {
            ...
            if (text != null)
            {
                text.text = LocalizeManager.Localize("$Ui_Constr_FinenessDP01",
                    new Il2CppSystem.Object[] {
                        Ui.Colorize(_ColorNumber, slider.value.ToString("F0"), false),
                        Ui.Colorize(_ColorNumber, "*", false) });
            }
            Debug.Log("Changing fineness to say: ' " + Ui.Colorize(_ColorNumber, slider.value.ToString("F0"), false) + " '");
            Il2CppUiExt.UiExt.SetTooltip(fineSlider, "con_fineness");
        }
    }
}
