...
namespace TweaksAndFixes
{
    ...
    internal class Patch_CampaignConquestEvent
    {
        ...
        private static float GetConquestChance(CampaignConquestEvent _this, bool force)
        {
            ...
            var ratioLerped = Mathf.Lerp(MonoBehaviourExt.Param("conquest_event_chance_mult_starting_duration", 0.01f), MonoBehaviourExt.Param("conquest_event_chance_mult_full_duration", 0.5f), _this.DurationTotal / (float)_this.maxDuration)
            ...
            {
                ratioLerped += MonoBehaviourExt.Param("conquest_event_add_chance", 0.66f);
            ...
            _this.cachedConquestChance = Mathf.Clamp01(Mathf.LerpUnclamped(1f, killFactor, MonoBehaviourExt.Param("conquest_event_kill_factor", 1f)) * ratioLerped);
            return _this.cachedConquestChance;
        }
    }
}
