...
namespace TweaksAndFixes
{
    ...
    {
        internal static CampaignController._AiManageFleet_d__200? _AiManageFleet = null;
    ...
    [HarmonyPatch(typeof(CampaignController._AiManageFleet_d__200))]
    internal class Patch_AiManageFleet
    {
        [HarmonyPatch(nameof(CampaignController._AiManageFleet_d__200.MoveNext))]
        [HarmonyPrefix]
        internal static void Prefix_MoveNext(CampaignController._AiManageFleet_d__200 __instance)
        {
        ...
        [HarmonyPatch(nameof(CampaignController._AiManageFleet_d__200.MoveNext))]
        [HarmonyPostfix]
        internal static void Postfix_MoveNext(CampaignController._AiManageFleet_d__200 __instance)
        {
